      ...
      <form action="" method="post" >
        ...
        <div class="row">
          <div class="col-50">
            ...
            <input type="text" id="addr" name="addr" placeholder="54 W. John Street">
            ...
            <div class="row">
              ...
              <div class="col-50">
                ...
                <input type="text" id="zip" name="zip" placeholder="00001">
              </div>
            </div>
          </div>
          ...
          <div class="col-50">
            ...
            <input type="text" id="Exp_month" name="Exp_month" placeholder="09">
            <div class="row">
              <div class="col-50">
                <label for="expyear">Exp Year</label>
                <input type="text" id="Exp_year" name="Exp_year" placeholder="23">
              </div>
              <div class="col-50">
        ...
        <input type="submit" value="Confirm Checkout and Process Payment" class="btn" onclick="Insert_Customer()">
      </form>
    </div>
</div>
